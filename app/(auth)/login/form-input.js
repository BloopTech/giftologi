      ...
      >
        ...
        <div className="w-full flex flex-col space-y-3">
          ...
          <div className="text-sm text-center">
            <Link
              ...
              className="text-[#A5914B] hover:text-[#8a7a3d] underline underline-offset-2 cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-[#A5914B] rounded px-1"
            >
              Forgot Password?
            </Link>
          </div>
          {canShowResend ? (
            <div className="text-xs text-center">
              <button
                ...
                className="cursor-pointer text-[#A5914B] hover:text-[#8a7a3d] underline underline-offset-2 disabled:opacity-60 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-[#A5914B] rounded px-1"
              >
                {isResendLoading
        ...
        <div className="w-full flex items-center justify-center pt-2">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/signup" className="text-[#A5914B] hover:text-[#8a7a3d] font-medium underline underline-offset-2 cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-[#A5914B] rounded px-1">
              Sign up
            </Link>
          </p>
        </div>
