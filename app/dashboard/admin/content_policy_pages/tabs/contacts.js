      ...
      {currentTab === "contact_info" ? (
        <div className="flex flex-col mt-2 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl border border-[#D6D6D6] bg-white p-4 space-y-1">
            ...
            <div className="rounded-xl border border-[#D6D6D6] bg-white p-4 space-y-1 md:col-span-2">
              <p className="text-[11px] font-medium text-[#0A0A0A]">
                WhatsApp Link
              </p>
