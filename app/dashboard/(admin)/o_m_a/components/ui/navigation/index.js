...
export default function AdminSidebar() {
  ...
  return (
    <>
      {/* sidebar (lg+) */}
      <nav className={`${pathname !== "/dashboard/s_a" ? "max-h-[28.5rem]" : "max-h-[27.5rem]"} hidden lg:mt-[6rem] mt-[2rem] h-auto py-4 w-full mx-auto max-w-[280px] lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col border border-[#f4f4f4] bg-white rounded-xl`}>
        {pathname !== "/dashboard/s_a" ? (
