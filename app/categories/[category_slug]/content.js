                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {subcategories.map((sub) => (
                    <Link
                      ...
                      className="inline-flex items-center px-3 py-1 rounded-full border border-gray-200 dark:border-gray-700 text-xs text-gray-600 dark:text-gray-400 hover:border-[#A5914B] hover:text-[#A5914B] transition-colors"
                    >
                      {sub.name}
                    </Link>
                  ))}
