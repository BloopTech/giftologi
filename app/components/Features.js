...
export default function Features() {
  return (
    <section
      id="features"
      className="pt-32 pb-16 px-6 sm:px-12 lg:px-24 bg-white relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-24 items-center w-full">
          ...
          <div className="relative order-2 lg:order-1 w-full">
            ...
            <div className="aspect-[4/3] rounded-[4rem] overflow-hidden shadow-2xl transform -rotate-3 group hover:rotate-0 transition-transform duration-700">
              <Image
            ...
            <div className="absolute top-12 -right-12 bg-[#f5f0e8] border border-[#e8dfc8] p-8 shadow-xl max-w-[220px] transform rotate-3 rounded-sm flex flex-col items-center justify-center min-h-[140px]">
              <span className="block text-4xl font-handwriting text-gray-800 mb-2 font-bold">
                98%
              </span>
              <span className="text-lg font-handwriting text-gray-800 leading-snug text-center">
