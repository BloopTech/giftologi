...
const TimeInput = forwardRef(({ hourCycle, ...props }, ref) => {
    ...
    return (
      <PopoverPrimitives.Trigger asChild>
        <button
          ...
          {...props}
        >
          <span className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-left text-gray-900 dark:text-[#f2f2f2]">
            {children ? (
              children
            ) : placeholder ? (
          ...
          <CalendarDays className="-ml-px size-5 shrink-0 transition sm:size-4 text-gray-400 dark:text-gray-600" />
        </button>
...
const formatDate = (date, locale, includeTime) => {
          ...
          <div className="flex flex-col sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <div className="flex items-center gap-x-2 border-t border-gray-200 p-3 dark:border-gray-800">
                <button
                  className="rounded-md px-4 py-1 cursor-pointer w-full border-gray-300 dark:border-gray-800 text-gray-900 dark:text-gray-50 bg-white dark:bg-gray-950 hover:bg-gray-50 dark:hover:bg-gray-900/60 disabled:text-gray-400 disabled:dark:text-gray-600"
                  type="button"
                  onClick={onCancel}
                >
                ...
                <button
                  className="rounded-md px-4 py-1 cursor-pointer w-full border-transparent text-white bg-[#A5914B] hover:bg-[#A5914B] disabled:bg-[#A5914B] disabled:text-gray-400 disabled:dark:bg-[#A5914B] disabled:dark:text-gray-400"
                  type="button"
                  onClick={onApply}
                >
...
const RangeDatePicker = ({
  ...
  const onCancel = () => {
    ...
    // Call onChange with null to clear the date selection from parent component
    onChange(null);
  };
  ...
  return (
    ...
    >
      <Trigger
        ...
        //className={className}
        className={cx(
          "w-full gap-x-1.5 whitespace-nowrap sm:w-fit sm:text-xs dark:text-gray-400 flex items-center rounded-md bg-white text-[#92959E] py-2 px-4 text-xs font-light cursor-pointer space-x-2",
            ...
            <div className="overflow-x-auto">
              ...
              <div className="border-t border-gray-200 p-3 sm:flex sm:items-center sm:justify-between dark:border-gray-800">
                ...
                <div className="mt-2 flex items-center gap-x-2 sm:mt-0">
                  <button
                    className="rounded-md px-4 py-1 cursor-pointer border w-full border-gray-300 dark:border-gray-800 text-gray-900 dark:text-gray-50 bg-white dark:bg-gray-950 hover:bg-gray-50 dark:hover:bg-gray-900/60 disabled:text-gray-400 disabled:dark:text-gray-600"
                    type="button"
                    onClick={onCancel}
                  >
                    {translations?.cancel ?? "Cancel"}
